...
module.exports = {
  ...
  // TODO: Do not forget to copy new ssl cert files to folder config/ssl
  ssl: {
    ...
    key: require('fs').readFileSync('config/ssl/privkey.pem'),
    cert: require('fs').readFileSync('config/ssl/fullchain.pem')
    // key: require('fs').readFileSync('/home/longnkh_larion/dfk/autodeploy/xcaller/xcaller-api/config/ssl/privkey.pem'),
    // cert: require('fs').readFileSync('/home/longnkh_larion/dfk/autodeploy/xcaller/xcaller-api/config/ssl/fullchain.pem')
  },
